...
public abstract class Board extends Observable implements Observer {
	...
	FlyBehaviour flyb;
	InitBehaviour initb;
	UpdateStockBehaviour updStockb;
	 ...
	 */
	public void setFLyBehav(FlyBehaviour beHav) {
		flyb = beHav;
	}
	...
	public void setInitBehaviour(InitBehaviour beHav) {
		initb = beHav;
	}

	public void initBoard(JFrame frame, Board b) {
		if (b.getClass() == FlockBoard.class)
			initb.doInitBoard(frame, (FlockBoard) b);
		else if (b.getClass() == StaticForageBoard.class)
			initb.doInitBoard(frame, (StaticForageBoard) b);
		else if (b.getClass() == MovingForageBoard.class)
			initb.doInitBoard(frame, (MovingForageBoard) b);
	}
	...
	public void doUpdateStock(Board b) {
		if (b.getClass() == FlockBoard.class)
			updStockb.doUpdateStock((FlockBoard) b);
		else if (b.getClass() == StaticForageBoard.class)
			updStockb.doUpdateStock((StaticForageBoard) b);
		else if (b.getClass() == MovingForageBoard.class)
			updStockb.doUpdateStock((MovingForageBoard) b);
	}
	/**
